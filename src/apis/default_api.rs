...
pub async fn function_name_get(
    configuration: &configuration::Configuration,
    function_name: &str,
) -> Result<crate::models::FunctionNameGet200Response, Error<FunctionNameGetError>> {
    ...
    let local_var_uri_str = format!(
        ...
        functionName = crate::apis::urlencode(function_name)
    );
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<FunctionNameGetError> =
...
pub async fn function_name_post(
    configuration: &configuration::Configuration,
    function_name: &str,
    function_name_post_request: Option<crate::models::FunctionNamePostRequest>,
) -> Result<crate::models::FunctionNamePost200Response, Error<FunctionNamePostError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<FunctionNamePostError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn root_get(
    configuration: &configuration::Configuration,
) -> Result<Vec<String>, Error<RootGetError>> {
    let local_var_configuration = configuration;
